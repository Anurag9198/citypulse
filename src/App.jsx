...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-blue-600 selection:text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-[500px] w-full bg-gradient-to-b from-blue-900/20 via-slate-950/50 to-transparent pointer-events-none -z-10 blur-3xl opacity-60"></div>
      <div className="absolute -top-[200px] -right-[200px] w-[500px] h-[500px] rounded-full bg-indigo-600/10 pointer-events-none -z-10 blur-3xl"></div>
      <div className="absolute top-[20%] -left-[100px] w-[300px] h-[300px] rounded-full bg-emerald-600/5 pointer-events-none -z-10 blur-3xl"></div>
      {/* Top Bar Header */}
      <Header
